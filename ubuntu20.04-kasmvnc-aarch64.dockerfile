...
&& wget -nv https://github.com/kasmtech/KasmVNC/releases/download/v1.2.0/kasmvncserver_focal_1.2.0_arm64.deb -P /tmp \
&& apt install -y /tmp/kasmvncserver_focal_1.2.0_arm64.deb \
