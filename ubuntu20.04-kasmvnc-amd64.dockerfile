...
&& apt install -y wget \
&& wget -nv https://github.com/kasmtech/KasmVNC/releases/download/v1.2.0/kasmvncserver_focal_1.2.0_amd64.deb \
&& apt install -y ./kasmvncserver_focal_1.2.0_amd64.deb \
&& rm -f ./kasmvncserver_focal_1.2.0_amd64.deb \
