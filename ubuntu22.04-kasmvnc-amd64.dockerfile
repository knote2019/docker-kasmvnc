...
&& apt install -y wget \
&& wget -nv https://github.com/kasmtech/KasmVNC/releases/download/v1.2.0/kasmvncserver_jammy_1.2.0_amd64.deb \
&& apt install -y ./kasmvncserver_jammy_1.2.0_amd64.deb \
